#
# Runs the validation set received
# from Paul
#
...
for page in os.listdir(pathToProvidedData + "images"):
    ...
    # Skip this part if we have already created the images
    if( not os.path.exists( "images/" + str(page_number) ) ):
      print(page)
...
Validation.do_validation( pathToProvidedData , True );
