...
train_set_str = "data/train.csv"
test_set_str = "data/mnist_test.csv"

train_x, train_y = load_train_data( train_set_str )
data = ( train_x, train_y )

train = Train( num_epochs , learning_rate , hidden_layer_size , train_x , train_y)
...
f = open('results/classification.txt', 'w')
i = 1
